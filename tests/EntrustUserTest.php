...
use daimekashiya\Entrust\Contracts\EntrustUserInterface;
use daimekashiya\Entrust\Traits\EntrustUserTrait;
use Illuminate\Cache\ArrayStore;
use Illuminate\Support\Facades\Config;
use Illuminate\Support\Facades\Cache;
use daimekashiya\Entrust\Permission;
use daimekashiya\Entrust\Role;
use Mockery as m;
...
class EntrustUserTest extends TestCase
{
    ...
    {
        $permMock = m::mock('daimekashiya\Entrust\Permission');
    ...
    {
        $roleMock = m::mock('daimekashiya\Entrust\Role');
